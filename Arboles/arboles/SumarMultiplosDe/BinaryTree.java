...
public class BinaryTree {
	...
	private int sumarNodosNodosMultiplosDeSeis(BinaryNode root) {
		
		int suma = root.getElement()%6 == 0
				   ? root.getElement()
				   : 0;
		...
		return suma +=
				(sumarNodosNodosMultiplosDeSeis(root.getLeft())
				+ sumarNodosNodosMultiplosDeSeis(root.getRight()));			
