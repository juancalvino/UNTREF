...
//	}
   ...
   public void nodoPadreSumaDeSusHijos() {
	   nodoPadreSumaDeSusHijos(root);
   } 
   
   public int nodoPadreSumaDeSusHijos(Node root) {
	   ...
	   if(root.left != null) {
		   aux += root.left.value;
		   nodoPadreSumaDeSusHijos(root.left);
	   }
	   if(root.right!= null) {
		   aux += root.right.value;
		   nodoPadreSumaDeSusHijos(root.right);
	   }
	   
	   return root.value = aux;
   }
}
